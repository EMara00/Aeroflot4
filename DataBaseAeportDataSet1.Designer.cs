...
namespace Aeroport.DataBaseAeportDataSet1TableAdapters {
    ...
    public partial class InformationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Information] ([Familia], [Name], [Otchestvo], [Document], [Nomer], [Grazdanstvo], [Compania], [Class], [StrOtpr], [DateTime], [StrPrib]) VALUES (@Familia, @Name, @Otchestvo, @Document, @Nomer, @Grazdanstvo, @Compania, @Class, @StrOtpr, @DateTime, @StrPrib);
SELECT Id, Familia, Name, Otchestvo, [Document], Nomer, Grazdanstvo, Compania, Class, StrOtpr, DateTime, StrPrib FROM Information WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Information] SET [Familia] = @Familia, [Name] = @Name, [Otchestvo] = @Otchestvo, [Document] = @Document, [Nomer] = @Nomer, [Grazdanstvo] = @Grazdanstvo, [Compania] = @Compania, [Class] = @Class, [StrOtpr] = @StrOtpr, [DateTime] = @DateTime, [StrPrib] = @StrPrib WHERE (([Id] = @Original_Id) AND ((@IsNull_Familia = 1 AND [Familia] IS NULL) OR ([Familia] = @Original_Familia)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Otchestvo = 1 AND [Otchestvo] IS NULL) OR ([Otchestvo] = @Original_Otchestvo)) AND ((@IsNull_Document = 1 AND [Document] IS NULL) OR ([Document] = @Original_Document)) AND ((@IsNull_Nomer = 1 AND [Nomer] IS NULL) OR ([Nomer] = @Original_Nomer)) AND ((@IsNull_Grazdanstvo = 1 AND [Grazdanstvo] IS NULL) OR ([Grazdanstvo] = @Original_Grazdanstvo)) AND ((@IsNull_Compania = 1 AND [Compania] IS NULL) OR ([Compania] = @Original_Compania)) AND ((@IsNull_Class = 1 AND [Class] IS NULL) OR ([Class] = @Original_Class)) AND ((@IsNull_StrOtpr = 1 AND [StrOtpr] IS NULL) OR ([StrOtpr] = @Original_StrOtpr)) AND ((@IsNull_DateTime = 1 AND [DateTime] IS NULL) OR ([DateTime] = @Original_DateTime)) AND ((@IsNull_StrPrib = 1 AND [StrPrib] IS NULL) OR ([StrPrib] = @Original_StrPrib)));
SELECT Id, Familia, Name, Otchestvo, [Document], Nomer, Grazdanstvo, Compania, Class, StrOtpr, DateTime, StrPrib FROM Information WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Familia, Name, Otchestvo, Document, Nomer, Grazdanstvo, Compania, Clas" +
                "s, StrOtpr, DateTime, StrPrib FROM Information";
